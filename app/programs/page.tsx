...
const schedule: ScheduleRow[] = [
  ...
  },
  {
    ...
    fall: '12 sessions • $540',
    winter: '13 sessions • $585',
    fullSeason: '25 sessions • $1,125',
  },
  {
    program: 'Private Lessons',
    time: 'Saturday 10:00–11:00 AM or 11:00 AM–12:00 PM',
    fall: '12 sessions • $1,200',
    winter: '13 sessions • $1,300',
    fullSeason: '25 sessions • $1,875',
  },
  {
      ...
      <section id="program-schedule" className="mx-auto max-w-6xl px-4 py-14 md:px-6">
        ...
        <div className="mt-6 rounded-2xl bg-gradient-to-r from-primary to-primary/80 p-4 text-center sm:p-6">
          <p className="font-bold text-primary-foreground">
            Register before Nov 2 and save 10% on Winter Session!
          </p>
          <p className="mt-1 text-sm text-primary-foreground/90">
            Early Bird Discount applies to winter session tuition only (does not apply to admin fee, off ice lessons, or private lessons)
          </p>
        </div>
